...
public class UserInterface extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        idCol.setPrefWidth(200); // Set preferred width for ID column
        ...
        gradeNumberCol.setPrefWidth(200); // Set preferred width for grade number column
        ...
        gradeCol.setPrefWidth(200); // Set preferred width for grade letter column
        ...
        attendanceCol.setPrefWidth(200); // Set preferred width for attendance percentage c1olumn
        ...
        Scene scene = new Scene(new ScrollPane(vbox), 800, 550); // Increased width to accommodate wider columns
